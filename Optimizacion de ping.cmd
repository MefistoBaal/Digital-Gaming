:: Usalo bajo tu propio riezgo. No hay garantia de que funcione el 100% de las veces.
:: Software para el uso de EVOT e interesados. Porfa no lo piratees :(
:: MefistoBaal
CLS
@ECHO OFF
ECHO  *** OPTIMIZA TU CONEXION TCP/IP  ***
ECHO.
ECHO  Esta wea sirve para optimizar el ping de los juegos y aplicaciones para Livestreaming.
...
CLS
ECHO  * DEFAULT VALUES SUCCESFULLY APPLIED - PRESIONA ENTER PARA SALIR *
GOTO SUCCESS
